...
static void lcm_get_params(struct LCM_PARAMS *params)
{
	...
	params->dsi.PLL_CLOCK 						= 234; 		  //2lane
	...
	params->dsi.horizontal_backporch		= 98;
...
static void lcm_suspend(void)
{
	...
	LCD_DEBUG("kernel:st7701_lcm_suspend  ---gl---\n");
}
...
/*#if 1
	//reset low to high
	mt_set_gpio_dir(GPIO_DISP_LRSTB_PIN, GPIO_OUT_ONE);
	MDELAY(1);
	mt_set_gpio_dir(GPIO_DISP_LRSTB_PIN, GPIO_OUT_ZERO);
	MDELAY(1);
	mt_set_gpio_dir(GPIO_DISP_LRSTB_PIN, GPIO_OUT_ONE);
	MDELAY(120);
...
*/
	...
	LCD_ERROR("kernel:st7701_lcm_resume  ---gl---\n");
}



struct LCM_DRIVER st7701_dsi_vdo_fwvga_gl_lcm_drv =
{
    .name           	= "st7701_dsi_vdo_fwvga_gl",
