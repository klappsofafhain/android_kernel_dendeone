...
static void lcm_init(void)
{
	...
	LCD_ERROR("st7701_lcm_init ------hl_mp------\n");
}
...
static void lcm_suspend(void)
{
	...
	LCD_ERROR("kernel:st7701_lcm_suspend ------hl_mp------\n");
}
...
static void lcm_resume(void)
{
	...
	LCD_ERROR("kernel:st7701_lcm_resume ------hl_mp------\n");
}

struct LCM_DRIVER st7701_dsi_vdo_fwvga_hl_mp_lcm_drv =
{
    .name           	= "st7701_dsi_vdo_fwvga_hl_mp",
