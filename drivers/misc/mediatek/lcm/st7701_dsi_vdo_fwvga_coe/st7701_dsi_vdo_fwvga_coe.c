...
static void lcm_suspend(void)
{
	...
	LCD_ERROR("kernel:st7701_lcm_suspend ------coe------\n");
}
...
static void lcm_resume(void)
{
	...
	LCD_ERROR("kernel:st7701_lcm_resume ------coe------\n");
}

struct LCM_DRIVER st7701_dsi_vdo_fwvga_coe_lcm_drv =
{
    .name           	= "st7701_dsi_vdo_fwvga_coe",
