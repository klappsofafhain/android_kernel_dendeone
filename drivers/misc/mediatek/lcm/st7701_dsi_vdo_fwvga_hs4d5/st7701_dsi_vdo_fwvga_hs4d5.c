...
static void lcm_init(void)
{
	...
	LCD_ERROR("st7701_lcm_init ------hs4d5------\n");
}
...
static void lcm_suspend(void)
{
	...
	LCD_ERROR("kernel:st7701_lcm_suspend ------hs4d5------\n");
}
...
static void lcm_resume(void)
{
	...
	LCD_ERROR("kernel:st7701_lcm_resume ------hs4d5------\n");
}



struct LCM_DRIVER st7701_dsi_vdo_fwvga_hs4d5_lcm_drv =
{
