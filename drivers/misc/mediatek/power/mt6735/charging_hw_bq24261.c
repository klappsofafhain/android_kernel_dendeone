...
static unsigned int charging_hw_init(void *data)
{
    ...
    //in bq24261_set_ichg
    bq24261_config_interface(bq24261_CON4, 0x7, 0x1F,3); // ICHG to BAT 

    bq24261_config_interface(bq24261_CON4, 0x1, 0x7, 0); // ITERM to BAT          
...
static unsigned int charging_set_cv_voltage(void *data)
{
	...
	//static unsigned int pre_register_value = -1;
    ...
    if(pmic_get_register_value(PMIC_SWCID) == PMIC6325_E1_CID_CODE) 
    {
