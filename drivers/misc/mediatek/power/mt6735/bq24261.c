...
/**********************************************************
  ...
  *
  *********************************************************/
int bq24261_read_byte(unsigned char cmd, unsigned char *returnData)
{
    char     cmd_buf[1]={0x00};
    char     readData = 0;
    int      ret=0;
...
int bq24261_write_byte(unsigned char cmd, unsigned char writeData)
{
    char    write_data[2] = {0};
    int     ret=0;
...
/**********************************************************
  ...
  *
  *********************************************************/
unsigned int bq24261_read_interface (unsigned char RegNum, unsigned char *val, unsigned char MASK, unsigned char SHIFT)
{
...
unsigned int bq24261_config_interface (unsigned char RegNum, unsigned char val, unsigned char MASK, unsigned char SHIFT)
{
    unsigned char bq24261_reg = 0;
    int ret = 0;
...
unsigned int bq24261_reg_config_interface (unsigned char RegNum, unsigned char val)
{   
    int ret = 0;
...
EXPORT_SYMBOL(bq24261_reg_config_interface);
/**********************************************************
  *
  *   [Internal Function] 
  *
...
void bq24261_set_tmr_rst(unsigned int val)
{
    int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON0), 
                                    (unsigned char)(val),
...
void bq24261_set_en_boost(unsigned int val)
{
    unsigned int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON0), 
                                    (unsigned char)(val),
                                    (unsigned char)(CON0_EN_BOOST_MASK),
                                    (unsigned char)(CON0_EN_BOOST_SHIFT)
                                    );
}

unsigned int bq24261_get_stat(void)
{
    unsigned int ret=0;
    unsigned char val=0;

    ret=bq24261_read_interface(     (unsigned char)(bq24261_CON0), 
                                    (&val),
...
void bq24261_set_en_shipmode(unsigned int val)
{
    unsigned int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON0), 
                                    (unsigned char)(val),
                                    (unsigned char)(CON0_EN_SHIPMODE_MASK),
                                    (unsigned char)(CON0_EN_SHIPMODE_SHIFT)
                                    );
}

unsigned int bq24261_get_fault(void)
{
    unsigned int ret=0;
    unsigned char val=0;
...
void bq24261_set_reset(unsigned int val)
{
    unsigned int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON1), 
                                    (unsigned char)(val),
                                    (unsigned char)(CON1_RESET_MASK),
                                    (unsigned char)(CON1_RESET_SHIFT)
                                    );
}

void bq24261_set_in_limit(unsigned int val)
{
    unsigned int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON1), 
                                    (unsigned char)(val),
                                    (unsigned char)(CON1_IN_LIMIT_MASK),
                                    (unsigned char)(CON1_IN_LIMIT_SHIFT)
                                    );
}

void bq24261_set_en_stat(unsigned int val)
{
    unsigned int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON1), 
                                    (unsigned char)(val),
                                    (unsigned char)(CON1_EN_STAT_MASK),
                                    (unsigned char)(CON1_EN_STAT_SHIFT)
                                    );
}

void bq24261_set_te(unsigned int val)
{
    unsigned int ret=0;    
...
void bq24261_set_dis_ce(unsigned int val)
{
    unsigned int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON1), 
                                    (unsigned char)(val),
                                    (unsigned char)(CON1_DIS_CE_MASK),
                                    (unsigned char)(CON1_DIS_CE_SHIFT)
                                    );
}

void bq24261_set_hz_mode(unsigned int val)
{
    unsigned int ret=0;    
...
void bq24261_set_vbreg(unsigned int val)
{
    unsigned int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON2), 
                                    (unsigned char)(val),
                                    (unsigned char)(CON2_VBREG_MASK),
                                    (unsigned char)(CON2_VBREG_SHIFT)
                                    );
}

void bq24261_set_mod_freq(unsigned int val)
{
    unsigned int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON2), 
                                    (unsigned char)(val),
                                    (unsigned char)(CON2_MOD_FREQ_MASK),
                                    (unsigned char)(CON2_MOD_FREQ_SHIFT)
                                    );
}

//CON3----------------------------------------------------

unsigned int bq24261_get_vender_code(void)
{
    unsigned int ret=0;
    unsigned char val=0;

    ret=bq24261_read_interface(     (unsigned char)(bq24261_CON3), 
                                    (&val),
...
unsigned int bq24261_get_pn(void)
{
    unsigned int ret=0;
    unsigned char val=0;
...
void bq24261_set_ichg(unsigned int val)
{
    unsigned int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON4), 
                                    (unsigned char)(val),
                                    (unsigned char)(CON4_ICHRG_MASK),
                                    (unsigned char)(CON4_ICHRG_SHIFT)
                                    );
}

void bq24261_set_iterm(unsigned int val)
{
    unsigned int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON4), 
                                    (unsigned char)(val),
                                    (unsigned char)(CON4_ITERM_MASK),
                                    (unsigned char)(CON4_ITERM_SHIFT)
                                    );
}

//CON5----------------------------------------------------

unsigned int bq24261_get_minsys_status(void)
{
    unsigned int ret=0;
    unsigned char val=0;

    ret=bq24261_read_interface(     (unsigned char)(bq24261_CON5), 
                                    (&val),
                                    (unsigned char)(CON5_MINSYS_STATUS_MASK),
                                    (unsigned char)(CON5_MINSYS_STATUS_SHIFT)
                                    );
    return val;
}

unsigned int bq24261_get_vindpm_status(void)
{
    unsigned int ret=0;
    unsigned char val=0;
    ...
    ret=bq24261_read_interface(     (unsigned char)(bq24261_CON5), 
                                    (&val),
                                    (unsigned char)(CON5_VINDPM_STATUS_MASK),
                                    (unsigned char)(CON5_VINDPM_STATUS_SHIFT)
                                    );
    return val;
}

void bq24261_set_low_chg(unsigned int val)
{
    unsigned int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON5), 
                                    (unsigned char)(val),
...
void bq24261_set_dpdm_en(unsigned int val)
{
    unsigned int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON5), 
                                    (unsigned char)(val),
                                    (unsigned char)(CON5_DPDM_EN_MASK),
                                    (unsigned char)(CON5_DPDM_EN_SHIFT)
                                    );
}

unsigned int bq24261_get_cd_status(void)
{
    unsigned int ret=0;
    unsigned char val=0;
...
void bq24261_set_vindpm(unsigned int val)
{
    unsigned int ret=0;    
...
void bq24261_set_2xtmr_en(unsigned int val)
{
    unsigned int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON6), 
                                    (unsigned char)(val),
...
void bq24261_set_tmr(unsigned int val)
{
    unsigned int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON6), 
                                    (unsigned char)(val),
                                    (unsigned char)(CON6_TMR_MASK),
                                    (unsigned char)(CON6_TMR_SHIFT)
                                    );
}

void bq24261_set_boost_ilim(unsigned int val)
{
    unsigned int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON6), 
                                    (unsigned char)(val),
                                    (unsigned char)(CON6_BOOST_ILIM_MASK),
                                    (unsigned char)(CON6_BOOST_ILIM_SHIFT)
                                    );
}

void bq24261_set_ts_en(unsigned int val)
{
    unsigned int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON6), 
                                    (unsigned char)(val),
                                    (unsigned char)(CON6_TS_EN_MASK),
                                    (unsigned char)(CON6_TS_EN_SHIFT)
                                    );
}

unsigned int bq24261_get_ts_fault(void)
{
    unsigned int ret=0;
    unsigned char val=0;

    ret=bq24261_read_interface(     (unsigned char)(bq24261_CON6), 
                                    (&val),
                                    (unsigned char)(CON6_TS_FAULT_MASK),
                                    (unsigned char)(CON6_TS_FAULT_SHIFT)
                                    );
    return val;
}

void bq24261_set_vindpm_off(unsigned int val)
{
    unsigned int ret=0;    

    ret=bq24261_config_interface(   (unsigned char)(bq24261_CON6), 
                                    (unsigned char)(val),
                                    (unsigned char)(CON6_VINDPM_OFF_MASK),
                                    (unsigned char)(CON6_VINDPM_OFF_SHIFT)
                                    );
}
...
/**********************************************************
  ...
  *
  *********************************************************/
unsigned char g_reg_value_bq24261=0;
...
MODULE_AUTHOR("James Lo<james.lo@mediatek.com>" || modified by Andie Klampfe für Android Q);
