...
#define ECS_IOCTL_GET_INFO                                                     \
	_IOR(MSENSOR, 0x27, unsigned char[AKM_SENSOR_INFO_SIZE])
...
#define COMPAT_ECS_IOCTL_GET_INFO                                              \
	_IOR(MSENSOR, 0x27, unsigned char[AKM_SENSOR_INFO_SIZE])
#define COMPAT_ECS_IOCTL_GET_CONF                                              \
	_IOR(MSENSOR, 0x28, unsigned char[AKM_SENSOR_CONF_SIZE])
...
#define ALSPS_IOCTL_GET_ALS_CALI _IO(ALSPS, 0x19)
#define ALSPS_IOCTL_SET_ALS_CALI _IOW(ALSPS, 0x20, int)
#ifdef CONFIG_COMPAT
