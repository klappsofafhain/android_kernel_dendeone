 ...
 * Author: MingHsien Hsieh <minghsien.hsieh@mediatek.com>
           customized for Aquaris A4.5 by Andreas Schmidt <andi_schmidt@posteo.de>
 *
...
/*----------------------------------------------------------------------------*/
MODULE_AUTHOR("custom_for_Aquaris_A4-5 by Andie_Klampfe");
